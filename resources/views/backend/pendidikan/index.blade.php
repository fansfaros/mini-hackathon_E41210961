                    ...
                    <div class="modal fade" id="basicModal" tabindex="-1">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form id="agama_form" method="POST"
                                    action="{{ route('agama.store') }}">
                                    @csrf
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="tingkatan">Agama</label>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('agama.destroy', $item->id) }}" method="POST"
                                        class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form id="edit_pendidikan_form" method="POST"
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group mb-3">
                                                    <label for="nama">Nama Takmir</label>
